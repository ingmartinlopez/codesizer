...
/**
 * TemplateProjectTypeFeatureTypeId generated by hbm2java
 */
@Embeddable
public class TemplateProjectTypeFeatureTypeId implements java.io.Serializable {

	private int idProjectType;
	private int idFeatureType;

	public TemplateProjectTypeFeatureTypeId() {
	}

	public TemplateProjectTypeFeatureTypeId(int idProjectType, int idFeatureType) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TemplateProjectTypeFeatureTypeId))
			return false;
		TemplateProjectTypeFeatureTypeId castOther = (TemplateProjectTypeFeatureTypeId) other;
