...
import com.devgear.codesizer.template.view.TemplateActivityComponent;
	...
	public MainLayout() {
        ...
        templates.addItem("Activities", new Command() {
			...
			public void menuSelected(MenuItem selectedItem) {
				...
				TemplateActivityComponent panel = (TemplateActivityComponent) ApplicationHelper.getApplicationContext().getBean("TemplateActivityComponent");
